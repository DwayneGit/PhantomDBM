...
class PhtmEditorWidget(QWidget):
    def __init__(self, fileHandler, parent):
        ...
        self.__editorTabs.setMovable(True)
        self.__editorTabs.setTabsClosable(True)
    ...
    def deleteScript(self, index):
        ...
        self.__editorTabs.closeTabByText(item.text(0))
    ...
    def handleContextMenuRequested(self, pos):
        ...
        if item:
            ...
            if self.__scriptTree.indexOfTopLevelItem(item) == -1:
                ...
                runBelow.triggered.connect(lambda: self.__r_ctrl.run(2, index))
