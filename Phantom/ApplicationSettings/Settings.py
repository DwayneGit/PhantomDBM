...
from Phantom.Logging import PhtmLogger

from .PhtmIcons import PhtmIcons
...
class _Settings():
    ...
    def __setDefaultSettings(self):
        settings = {
            'theme':"Phantom/ApplicationSettings/Themes/1_dark.json", 
            "recent_files":[]
        }
        json.dump(settings, open(self.settingsFile, 'w+'), indent=4, separators=(',', ': '))
